...
// 保持します。
//
// ここに入れるものと入れないものの線引きは意図的です。トレイ、コンソール出力、
// そしてユーザーが対処すると想定される少数のエラーは読み手に向けて書かれたもの
// なので、翻訳します。ログは違います。ログは診断の記録であり、不具合報告に貼られ、
// その文言で検索されます。実行した機械によって言語が変わるログは、後から読む
// 全員にとって価値が下がります。/stats と /api/v1/* の応答も同様で、これらは
// プログラムが読みます。
//
